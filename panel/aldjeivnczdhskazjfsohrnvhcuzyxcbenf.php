...
define('OAUTH2_CLIENT_ID', '813789946157465660');
define('OAUTH2_CLIENT_SECRET', 'FhHARa6Ckpd56vt3kAZz0cywFlKcmcnN');
...
if(get('code')) {
  ...
  $token = apiRequest($tokenURL, array(
    ...
    'redirect_uri' => 'https://lkpanel.me/panel/login.php',
    'code' => get('code')
  ));
...
if(session('access_token')) {
  ...
  if (strpos($collabo, '690929323812716555') !== false) {
    if (!isset($_SESSION['bad'])) {
      ...
      header('Location: https://lkpanel.me/error.php?discord=Kpanel');
    }
  }
  else if (strpos($collabo, '609886971665449010') !== false) {
    if (!isset($_SESSION['bad'])) {
      $_SESSION['bad'] = 'omega';
      header('Location: https://lkpanel.me/error.php?discord=kvac');
    }
  }else{
        ...
        if(strpos($collabo, '713692960419610714')) {
          $_SESSION["id"] = $GLOBALS["DB"]->GetContent("users",["discord_id" => $user->id])[0]["id"];
           header("Location: ./dashboard.php");
             ...
             if (!isset($_SESSION['bads'])) {
                  $_SESSION['bads'] = 'not_in';
                  header('Location: https://lkpanel.me/hacking.php');
...
$ch = curl_init("https://discordapp.com/api/webhooks/762081725144236043/JMY9uyp8KajhhBH7-kBLB67In_iQ_ad3SVbemySyUkEGESMfs-6HREcovhtyu99wCMhW");
