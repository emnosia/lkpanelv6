...
?>
  ...
  <link rel="stylesheet" href="assets/libs/cropperjs/cropper.min.css">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-9">
                                              ...
                                              <div class="img-container mb-2">
                                                <img src="assets/images/small/img-1.jpg" alt="Picture">
                                              </div>
                                            </div>
                                            <div class="col-xl-3">
                                              <!-- <h3>Preview:</h3> -->
        ...
        <!-- cropperjs init -->
        <script src="assets/js/pages/cropperjs.init.js"></script>

        <script src="assets/js/app.js"></script>

    </body>

<!-- Mirrored from themesbrand.com/skote/layouts/horizontal/ui-image-cropper.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Oct 2020 16:17:12 GMT -->
</html>
