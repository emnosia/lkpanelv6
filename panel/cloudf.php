                ...
                <div class="card-body">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <center>
                                <h2><strong> CLOUDFLARE RESOLVER</strong></h2>
                            </center>
                            <div class="panel-actions">
                                <a href="cloudf.php" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
                        ...
                        if (isset($_POST['resolve'])) {
                            ...
                            if ($username == null) {
                                ...
                                if ($username == "https://lkpanel.me" || $username == "https://emnosia.fr" || $username == "emnosia.fr" || $username == "lkpanel.me") { // When adding blacklisted username, use lowercase letters.
                                    ...
                                    $ip = @file_get_contents("http://lkpanel.me/api.php?key=M9HNW-VBJYB-WXW02-O9I8D&action=cloudflare&string={$username}"); // Put own API link with Key in here.
                                    echo "<div class='alert alert-success'><b>$username</b> : <font color='red'>$ip</font></div>";
                                }
                        }
                        ?>
                        <form method="POST">
                            <div class="form-group">
                                <input type="text" class="form-control" name="username" placeholder="Exemple : google.fr">
                            </div>
