  ...
  <div class="row">
            ...
            <div class="col-8 grid-margin">
              ...
              <div class="form-group">
                <textarea class="form-control" rows="30" id="chat-text" placeholder=""></textarea>
              </div>
              

             <center> <button type="submit" onclick="AddChat()" class="btn btn-success"><i class="fa fa-bolt"></i>&nbsp;Publier</button></center>
