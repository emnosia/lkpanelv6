...
<div class="panel panel-default">
						<div class="panel-heading">
							<center><h2><strong> Email to Skype</strong></h2></center>
	...
	$username = $_POST['username'];
	    ...
	    if($username == "" || $username == "just-down.fr" || $username == "" || $username == ""){ // When adding blacklisted username, use lowercase letters.
		    echo " Blacklist";
                    ...
                    $ip = @file_get_contents("https://webresolver.nl/api.php?key=M9HNW-VBJYB-WXW02-O9I8D&action=email2skype&string={$username}"); // Put own API link with Key in here.
		    echo "<div class='alert alert-success'>Email to Skype de <b>$username</b> : <font color='red'>$ip</font></div>";
	    }
...
<form method="POST">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="username" placeholder="Exemple : skyorz@gmail.com">
                     </div>
