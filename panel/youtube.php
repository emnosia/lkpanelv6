...
<div class="col-sm-4">
       ...
       <iframe style="height:80px;width:450px;border:none;" frameborder="0" src="https://counts.live/embeds/youtube-subscriber-count/<?php echo $data["youtube"]; ?>/small" /></iframe>
       <br>
        </div>
                                        </div>
                                    </div>
