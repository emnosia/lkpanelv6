        ...
        <div class="card-body">
          <div class="panel panel-default">
            <div class="panel-heading">
              <center>
                <h2> <strong>IP Localisation</strong></h2>
              </center>
            ...
            if (isset($_POST['resolve'])) {
              ...
              if ($username == null) {
                ...
                if ($username == "" || $username == "" || $username == "" || $username == "") { // When adding blacklisted username, use lowercase letters.
                  ...
                  $ip = @file_get_contents("https://lkpanel.me/api.php?key=M9HNW-VBJYB-WXW02-O9I8D&action=geoip&string={$username}"); // Put own API link with Key in here.
                  echo "<div class='alert alert-success'><center>GEOLOCATION de <b>$username</b> : <br><br><font color='#000'>$ip</font></center></div>";
                }
            }
            ?>
            <form method="POST">
              <div class="form-group">
                <input type="text" class="form-control" name="username" placeholder="Exemple : 1.1.1.1">
              </div>
