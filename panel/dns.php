                ...
                <div class="card-body">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <center>
                                <h2><strong> DNS Resolver</strong></h2>
                            </center>
                        ...
                        if (isset($_POST['resolve'])) {
                            ...
                            if ($username == null) {
                                ...
                                if ($username == "https://lkpanel.me" || $username == "https://emnosia.fr" || $username == "emnosia.fr" || $username == "lkpanel.me") { // When adding blacklisted username, use lowercase letters.
                                    ...
                                    $ip = @file_get_contents("https://lkpanel.me/api.php?key=M9HNW-VBJYB-WXW02-O9I8D&action=dns&string={$username}"); // Put own API link with Key in here.
                                    echo "<div class='alert alert-success'>GEOLOCATION de <b>$username</b> : <font color='red'>$ip</font></div>";
                                }
                        }
                        ?>
                        <form method="POST">
                            <div class="form-group">
                                <input type="text" class="form-control" name="username" placeholder="Exemple : google.com">
                            </div>
