  ...
  <div class="row">
            ...
            <div class="col-8 grid-margin">
              ...
              <div class="form-group">
                <textarea class="form-control" rows="29" id="payload-name" placeholder="Text"></textarea>
                <br>
                <textarea class="form-control" rows="1" id="payload-text" placeholder="Name"></textarea>
              </div>

             <center> <button type="button" onclick="createPayloads()" data-toggle="modal" data-target="#createpayload-modal" class="btn btn-success"><i class="fa fa-bolt"></i>&nbsp;Publier</button></center>
              ...
              <thead>
                  ...
                  <th scope="col">Action</th>
                   ...
                   <tbody>
                              <?php
                              $selectionserver = $GLOBALS['DB']->GetContent("payload", [], "ORDER BY id DESC");
                              $pah = 0;
                                      // Print Output
